  ...
  handleLikeClick(clickEvent) {
    ...
    if (clickEvent.button === 0) {
      ...
      if (this.didUserLike()) {
        ...
        unlikeComment(this.props.feedItemId, 4, callbackFunction, this.props.index);
      } else {
        // User clicked 'like' button.
        likeComment(this.props.feedItemId, 4, callbackFunction, this.props.index);
      }
    }
  }
    ...
    return (
      <div>
        ...
        <div className="media-body">
          <Link to={"/profile/" + this.state.author._id}>{this.state.author.fullName}</Link> {this.props.children}
